...
def receptive_field(model, input_size, batch_size=-1, device="cuda", return_zstruct_RF=False):
    """
    :parameter
    ...
    def register_hook(module):
        ...
        def hook(module, input, output):
            ...
            if not receptive_field["0"]["conv_stage"]:
                ...
                elif class_name == "BatchNorm2d" or class_name == "ReLU" or class_name == "Bottleneck" or \
                        class_name == "AdaptiveMaxPool2d" or class_name == "View" or class_name == "Dropout"\
                        or class_name == "Linear" or class_name == "Softmax" or class_name == "BatchNorm1d"\
                        or class_name == "Flatten":
